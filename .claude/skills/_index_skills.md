...
This directory contains reusable workflows and guidelines for common development tasks.
...
1. Load a skill via the AI command
2. Follow the lightweight guidance
3. Reference output files in memory bank
4. Cross-reference with related skills

## Creating New Skills

Skills follow this structure: purpose, audience, steps, patterns, rules of thumb, and Context7 MCP reference.
