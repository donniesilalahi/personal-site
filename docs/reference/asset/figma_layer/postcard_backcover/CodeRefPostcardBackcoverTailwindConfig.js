module.exports = {
  ...
  theme: {
    extend: {
      colors: {
        '1-color-modes-colors-border-border-primary':
          'var(--1-color-modes-colors-border-border-primary)',
        '1-color-modes-colors-border-border-secondary':
          'var(--1-color-modes-colors-border-border-secondary)',
        '1-color-modes-colors-text-text-secondary-700':
          'var(--1-color-modes-colors-text-text-secondary-700)',
        '1-color-modes-colors-text-text-tertiary-600':
          'var(--1-color-modes-colors-text-text-tertiary-600)',
        ...
        'primitives-colors-base-white-duplicate':
          'var(--primitives-colors-base-white-duplicate)',
        ...
        'primitives-colors-gray-light-mode-200-duplicate':
          'var(--primitives-colors-gray-light-mode-200-duplicate)',
        ...
        'primitives-colors-gray-light-mode-300-duplicate':
          'var(--primitives-colors-gray-light-mode-300-duplicate)',
        ...
        'primitives-colors-gray-light-mode-600-duplicate':
          'var(--primitives-colors-gray-light-mode-600-duplicate)',
        ...
        'primitives-colors-gray-light-mode-700-duplicate':
          'var(--primitives-colors-gray-light-mode-700-duplicate)',
      ...
      fontFamily: {
        'text-2xs-regular': 'var(--text-2xs-regular-font-family)',
