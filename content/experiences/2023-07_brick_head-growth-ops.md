---
company: 'Brick'
role: 'Head of Growth and Customer Operations'
...
Brick is Indonesia's leading open finance and real-time payments infrastructure company. I led two departments (Growth and Customer Operations) spanning 9 teams: Marketing, SDR, RevOps, Business Intelligence, Onboarding Ops, Payments Ops, Technical Sales, Customer Support, and Credit Operations.

##### The Role

Stepped in during a critical transition period to rebuild and scale both growth and operations functions. Turned scattered processes into measurable systems — making things manageable, improvable, and predictable.

##### Key Results

- Doubled top-funnel pipeline through improved lead qualification and industry-focused segmentation
- 70% shorter sales cycles via automation and standardization
- 3x cross-sell rates through deeper client use-case understanding
- Reduced transaction costs and processing failures through payment rail orchestration and multi-provider partnerships
- Lowered churn by routing customer issues directly into product roadmap
- Secured $XX million debt capital for financing product
- Credit underwriting reduced to under 2 working days
...
- Scaled content production system — improved organic rankings, social following, and lead quality
- Ran competitive analysis across content, positioning, advertising to shape strategy
- Experimented with ABM, CRO, remarketing, and startup perk programs
...
- Shifted BI from reactive reporting to proactive function with automated weekly digests and critical investigations
